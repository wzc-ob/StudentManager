 ...
 * @author 陈浩
 */
@WebServlet(name = "StuUpdateServletDo", urlPatterns = {"/StuUpdateServletDo"})
@MultipartConfig
public class StuUpdateServletDo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (flag) {
                response.sendRedirect(request.getContextPath() + "/StuDisplayServlet");
            } else {
