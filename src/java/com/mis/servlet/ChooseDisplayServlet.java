 ...
 * @author 陈浩
 */
@WebServlet(name = "ChooseDisplayServlet", urlPatterns = {"/ChooseDisplayServlet"})
public class ChooseDisplayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pagination.setUrl("ChooseDisplayServlet?");
        String sno = (String) request.getSession().getAttribute("userid");
        List<CourseTable> coursetable = DaoFactory.getCourseTableDao().getUnStuCourse(pagination, sno);
